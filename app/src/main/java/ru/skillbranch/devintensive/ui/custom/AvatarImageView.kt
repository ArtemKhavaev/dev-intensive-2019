...
class AvatarImageView @JvmOverloads constructor(
    ...
    defStyleAtts: Int = 0
): androidx.appcompat.widget.AppCompatImageView(context, attrs, defStyleAtts){
    ...
    private var initials: String = "ИРА"
...
//        super.onDraw(canvas)
    ...
    private fun resolveDefaultSize(spec:Int): Int{
        return when (MeasureSpec.getMode(spec)){
            MeasureSpec.UNSPECIFIED ->context.dpToPx(DEFAULT_SIZE).toInt() ///resolveDefaultSpec
